...
.badge{font-size:11px;font-weight:700;padding:3px 10px;border-radius:999px;background:rgba(233,200,74,.14);border:1px solid rgba(233,200,74,.42);color:var(--gold)}
...
.c-name a{color:#7fc7ff;text-decoration:none}.c-name a:hover{text-decoration:underline}
...
.note{background:rgba(233,200,74,.07);border:1px solid rgba(233,200,74,.25);border-radius:10px;padding:13px 15px;font-size:12.5px;color:#eadfb8;margin:16px 0}

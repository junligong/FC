...
- 调度：每天 06:30（Asia/Shanghai；2026-09-20 起由 06:00 后移），在「FC·汇总发布」（06:15，2026-09-20 起；原 03:35）之后，确保线上站点已是当日版本。后移原因：足球日报同日移到 06:00，本任务不得与足球日报同分钟触发，且必须排在汇总发布之后
...
- FC27 `launchDate=2026-09-18`（2026-09-20 定案；`2026-09-25` 是正式发售日，勿改回）：开服初期价格可能是 `listing-estimate` 列表估算口径、两个平台（Console / PC）价为 0 —— 不得当成交价、不得讲涨跌。**是否讲涨跌看当日实测 `priceBasis`**（无 ≥1000 coins 有效价时不得讲）

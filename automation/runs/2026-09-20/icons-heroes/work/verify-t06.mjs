// 一次性校验脚本（临时）：icons-pricerange-hourly 2026-09-20 T06 轮产物一致性核对（v2，字段结构已核正）。
// 全部跨文件关联一律按 cardId（FUTBIN slug 不唯一，禁用 slug/name 关联）。
// 输入：current.json / hourly T06 / hourly 前轮(2026-09-20T05) / daily 2026-09-20 / research JSON / base-icons.json / 两个 HTML

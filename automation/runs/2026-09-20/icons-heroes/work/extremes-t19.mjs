// 一次性脚本（临时）：icons-pricerange-hourly 2026-09-20 T19 轮区间极值并列张数 + 自洽性核对。
// 全部按 cardId 关联（禁 slug/name）。输入：hourly T19 快照（2026-09-20T19）+ research JSON。
...
// T19 为全量成功轮（131/131）：仅对采到区间的卡做极值统计（部分失败轮时未采到的卡 priceRange=null，如实排除，不填充）

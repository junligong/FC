...
const market = {
  ...
  dataCutoff: '2026-09-16 13:45 +08:00',
  ...
  sources: [
    { url: 'https://www.futbin.com/27/players', openedAt: '2026-09-16T13:29:47+08:00', note: '本轮实测打开，读取榜单首屏 30 行' },
    { url: 'https://www.futbin.com/27/players?page=2', openedAt: '2026-09-16T13:31:42+08:00', note: '本轮实测打开，读取第 2 页 30 行' },
    { url: 'https://www.futbin.com/27/players?page=3', openedAt: '2026-09-16T13:31:42+08:00', note: '本轮实测打开，读取第 3 页 30 行' },
    { url: 'https://www.futbin.com/27/popular', openedAt: '2026-09-16T13:29:47+08:00', note: '本轮实测打开，读取热门球员卡片' },
    { url: 'https://www.futbin.com/27/popular/evolutions', openedAt: '2026-09-16T13:29:47+08:00', note: '本轮实测打开，读取热门进化卡卡片' },
    { url: 'https://www.futbin.com/27/players?pc_price=1000000%2B', openedAt: '2026-09-16T13:30:07+08:00', note: '已打开，表头正常但 0 行：开服前价格筛选参数不可用' },
    { url: 'https://www.futbin.com/27/players?pc_price=300000-1000000', openedAt: '2026-09-16T13:30:08+08:00', note: '已打开，0 行：开服前价格筛选参数不可用' },
    { url: 'https://www.futbin.com/27/players?pc_price=10000-100000', openedAt: '2026-09-16T13:30:24+08:00', note: '已打开，0 行；该区间榜单中确有卡，确认筛选参数失效' },
  ],
  missing: [],
  overview: {
    weekly: { promo: [], totw: [] },

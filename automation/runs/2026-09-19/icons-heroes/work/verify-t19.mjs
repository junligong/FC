// 一次性校验脚本（临时）：icons-pricerange-hourly 2026-09-19 T18 轮产物一致性核对（v2，字段结构已核正）。
...
// T19 为「部分失败」轮（首批 8 张 403）：仅对 ok!==false 的卡做严格一致核对；
// ok===false 的卡必须「保留上一次观测、未被本轮空值污染」，单独核对。

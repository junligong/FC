// 一次性明细脚本（临时）：icons-pricerange-hourly 2026-09-19 T09 轮建议集变动与临界余量明细。
// 全部按 cardId 关联（FUTBIN slug 不唯一，禁用 slug/name 做键）。
// 双映射：复算前轮(T07)命中集用「生成 T06 产物时的同一版 FC26 映射」(research-prev-t07.json)，避免 slug 漂移 artifact。
...
const pres = j('automation/runs/2026-09-19/icons-heroes/work/research-prev-t07.json');

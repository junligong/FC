...
// 双映射：复算前轮(T09)命中集用「生成 T06 产物时的同一版 FC26 映射」(research-prev-t09.json)，避免 slug 漂移 artifact。
...
const pres = j('automation/runs/2026-09-19/icons-heroes/work/research-prev-t09.json');

// 一次性脚本（临时）：icons-pricerange-hourly 2026-09-19 T20 轮区间极值并列张数 + 自洽性核对。
// 全部按 cardId 关联（禁 slug/name）。输入：hourly T20 快照 + research JSON。
...
// T17 为部分失败轮：仅对采到区间的卡做极值统计（未采到的卡 priceRange=null，如实排除，不填充）

// 一次性脚本（临时）：icons-pricerange-hourly 2026-09-21 T07 轮产物一致性校验。
...
const COLLECTED_AT = '2026-09-20T23:50:30.219Z';
...
P(`  前轮基线(research-prev-t03) 自判 advice=${prev.counts.advice} · 我的复算 advice=${rePrev.advice}`);
